...
urlpatterns = [
    ...
    path('menucriancafuncionario', menucriancafuncionario, name='menucriancafuncionario'),
    path('albumrecordacoesfuncionario', albumrecordacoesfuncionario, name='albumrecordacoesfuncionario'),
